    ...
    if verificar_registro_existe(conexao, id):
        ...
        while dia_tipo == False:
            try:
                ...
                if dia_nascimento <= 0:
                    ...
                    if mes_nascimento == 1 or mes_nascimento == 3 or mes_nascimento == 5 or mes_nascimento == 7 or mes_nascimento == 8 or mes_nascimento == 10 or mes_nascimento == 12:
                        if dia_nascimento > 31:
                            print(f"\033[0;31mOops! Data inválida. O mês {mes_nascimento} não pode ter mais de 31 dias. \033[m")
                        else:
                            dia_tipo = True
                    elif mes_nascimento == 4 or mes_nascimento == 6 or mes_nascimento == 9 or mes_nascimento == 11:
        ...
        while salario_tipo == False:
            try:
                ...
                print("\033[0;31mOops! Esse não é um salário válido, insira apenas números!.\033[m")
